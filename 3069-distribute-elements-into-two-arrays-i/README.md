...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/distribute-elements-into-two-arrays-i/)
...
**My Solution:** [3069-Distribute-Elements-Into-Two-Arrays-I.py](./3069-Distribute-Elements-Into-Two-Arrays-I.py)
