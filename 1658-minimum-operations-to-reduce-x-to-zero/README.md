...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/minimum-operations-to-reduce-x-to-zero/)
...
**My Solution:** [1658-Minimum-Operations-to-Reduce-X-to-Zero.py](./1658-Minimum-Operations-to-Reduce-X-to-Zero.py)
